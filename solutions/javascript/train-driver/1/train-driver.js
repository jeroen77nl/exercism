 ...
 */
export function fixListOfWagons([fst, snd,...rest]) {
  return [...rest, fst, snd];
}
 ...
 */
export function correctListOfWagons([fst, ...rest], missingWagons) {
  return [fst, ...missingWagons, ...rest];
}
 ...
 */
export function separateTimeOfArrival({timeOfArrival, ...restInformation}) {
