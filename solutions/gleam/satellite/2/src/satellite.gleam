...
pub fn tree_from_traversals(
  ...
  let v1 = validate_length(inorder, preorder)
  let v2 = duplicate_elements(inorder, preorder)
  let v3 = same_elements(inorder, preorder)
  case v1, v2 ,v3 {
    False, _, _ -> Error(DifferentLengths)
    _, False, _ -> Error(NonUniqueItems)
    _, _, False -> Error(DifferentItems)
